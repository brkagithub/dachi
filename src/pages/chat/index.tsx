        ...
        <div className="max-w-2xl mx-auto pt-8 pr-4 pl-4 md:pl-2 md:pr-2">
          ...
          <div className="mx-auto pt-4">
            {friends?.map((req) => (
              <NextLink
                href={`chat/${
                  (req.requestInitiatorId != meData.id &&
                ...
                <div className="flex items-center cursor-pointer border rounded-3xl border-gray-400 p-2 mb-4">
                  <div className="flex justify-start items-center w-full">
                    <img
                      ...
                      src={
                        (req.requestInitiatorId != meData.id &&
                          req.requestInitiator.image) ||
                        (req.requestTargetId != meData.id &&
                          req.requestTarget.image) ||
                        ""
                      }
                    ></img>
                      ...
                      <div className="flex flex-col">
                        <div className="text-left underline">
                          ...
                          {(req.requestInitiatorId != meData.id &&
                            req.requestInitiator.name) ||
                            (req.requestTargetId != meData.id &&
                              req.requestTarget.name)}
                        </div>

                        <div className="text-sm text-left">
                          {req.lastMessage[0]?.body
                            ? req.lastMessage[0]?.body.length > 23
                              ? req.lastMessage[0]?.body.substring(0, 23) +
                                "..."
                              : req.lastMessage[0]?.body
