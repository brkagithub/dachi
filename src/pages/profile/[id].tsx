...
const ProfilePage = (props: { user: User }) => {
  ...
  return (
    <>
      ...
      ></img>
      <div className="mx-auto px-2 sm:px-6 lg:px-8 flex flex-col items-center">
        <div className="w-full md:flex md:justify-center">
          <div className="w-full md:w-2/5">
            <div className="w-full text-justify pt-2 pr-16">
              ...
              <div className="pt-2">
                ...
                Suspendisse in ante ac neque vehicula vestibulum non a urna.
                Nunc vitae massa eu quam pretium pharetra. Praesent dictum
                lectus ac nulla elementum consectetur at a leo.
              </div>
            </div>
          </div>
          <div>
            <img
              className="h-36 w-auto rounded-full relative bottom-16"
              src={props.user.image || ""}
            ></img>
            <div className="text-xl text-center relative bottom-16">
              {props.user.name}
            </div>
            <div className="flex pt-2 justify-between relative bottom-16">
              {props.user.twitter ? (
                <SocialIcon
          ...
          <div className="w-full md:w-2/5 flex md:justify-around pt-2 pl-8">
            <div>
              <img
